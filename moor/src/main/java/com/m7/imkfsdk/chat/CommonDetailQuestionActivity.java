...
//                    String count = jsonObject.getString("count");
                    ...
                    if (list != null && list.length() > 0) {
                        ...
                        //没有数据
                        Toast.makeText(CommonDetailQuestionActivity.this, "没有数据", Toast.LENGTH_SHORT).show();
            ...
            public void onSuccess(String responseStr) {
                ...
                try {
                    ...
                    if (list != null && list.length() > 0) {
                        ...
                        Toast.makeText(CommonDetailQuestionActivity.this, "没有更多数据了", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
