...
public enum ChatRowType {
     ...
     * 视频不展示
     */
    VIDEO_ROW_TRANSMIT("C1600R", Integer.valueOf(16)),
    /*
     * 收到的物流信息列表/收到的物流进度信息列表
     */
    LOGISTICS_INFORMATION_ROW_RECEIVED("C1700R", Integer.valueOf(17)),
    /*
     * 发送的物流信息类型
     */
    LOGISTICS_INFORMATION_ROW_TRANSMIT("C1700T", Integer.valueOf(18)),

    /*
     * 点击发送给坐席的卡片信息类型
     */
    ORDER_INFO_ROW_TRANSMIT("C2000T", Integer.valueOf(20)),
    /*
     * 发出的卡片信息类型
     */
    SEND_ORDER_INFO_ROW_TRANSMIT("C2100T", Integer.valueOf(21)),
