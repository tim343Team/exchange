...
public class TrustHistoryAdapter extends BaseQuickAdapter<EntrustHistory, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, EntrustHistory item) {
        if ("BUY".equals(item.getDirection())) {
            helper.setText(R.id.history_type, mContext.getResources().getString(R.string.text_buy)).setTextColor(R.id.history_type,
                    ContextCompat.getColor(MyApplication.getApp(), R.color.typeGreen));
        } else {
            helper.setText(R.id.history_type, mContext.getResources().getString(R.string.text_sale)).setTextColor(R.id.history_type,
        ...
        helper.setText(R.id.history_num_s, mContext.getResources().getString(R.string.text_volume) + "(" + item.getCoinSymbol() + ")");
        ...
        if ("LIMIT_PRICE".equals(item.getType())) { // 限价
            ...
            helper.setText(R.id.history_num, mContext.getResources().getString(R.string.text_entrust_num) + "(" + item.getCoinSymbol() + ")");
            ...
            if ("BUY".equals(item.getDirection())) {
                helper.setText(R.id.history_two, String.valueOf(mContext.getResources().getString(R.string.text_best_prices)));
                helper.setText(R.id.history_num, mContext.getResources().getString(R.string.text_total_entrust) + "(" + item.getBaseSymbol() + ")");
            } else {
                helper.setText(R.id.history_num, mContext.getResources().getString(R.string.text_entrust_num) + "(" + item.getCoinSymbol() + ")");
                helper.setText(R.id.history_two, String.valueOf(mContext.getResources().getString(R.string.text_best_prices)));
            }
        }
        helper.setText(R.id.history_wei, mContext.getResources().getString(R.string.text_wei_price) + "(" + item.getBaseSymbol() + ")");
        // 委托量
        ...
        helper.setText(R.id.history_total, mContext.getResources().getString(R.string.text_total_deal) + "(" + item.getBaseSymbol() + ")");
        // 成交均价
        ...
        helper.setText(R.id.history_average, mContext.getResources().getString(R.string.text_average_price) + "(" + item.getBaseSymbol() + ")");
        // 成交量
