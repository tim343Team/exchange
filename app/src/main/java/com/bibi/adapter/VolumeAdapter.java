...
public class VolumeAdapter extends RecyclerView.Adapter<VolumeAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (direct == null) {
            ...
            holder.tvDirect.setText(volumeInfo.getDirection().equals("SELL") ? context.getResources().getString(R.string.text_buy) : context.getResources().getString(R.string.text_sale));
