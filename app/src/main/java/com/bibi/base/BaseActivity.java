...
import com.bibi.R;
import com.bibi.ui.lock.LockActivity;
...
import com.bibi.utils.WonderfulKeyboardUtils;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected boolean uploadView = false;//解决从相册返回刷新Onstart方法时弹出手势的问题
    ...
    protected void onStart() {
        ...
        if (isNeedShowLockActivity() && !uploadView) LockActivity.actionStart(this);
    }
