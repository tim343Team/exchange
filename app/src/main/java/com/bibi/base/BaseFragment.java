...
public abstract class BaseFragment extends Fragment {
    ...
    protected void initImmersionBar() {
        ...
        immersionBar.keyboardEnable(false, WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN).statusBarDarkFont(true,0.2f).flymeOSStatusBarFontColor(R.color.help_view).init();
    }
