...
import com.bibi.adapter.ChooseCoinAdapter;
...
public class StickHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickHeaderDecoration(Context context, int headerColor, int textColor, int lineColor) {
        ...
        mItemHeaderPaint.setColor((headerColor));
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        if (parent.getAdapter() instanceof ChooseCoinAdapter) {
            ChooseCoinAdapter adapter = (ChooseCoinAdapter) parent.getAdapter();
