 ...
 */
public class SKlinePresenter implements SKlineContract.Presenter {
    private DataSource dataRepository;
    private SKlineContract.View view;

    public SKlinePresenter(DataSource dataRepository, SKlineContract.View view) {
    ...
    @Override
    public void SpotKData(String symbol, Long from, Long to, String resolution) {
        dataRepository.SpotKData(symbol, from, to, resolution, new DataSource.DataCallback() {
            @Override
