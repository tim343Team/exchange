 ...
 */
public class SIntroduceFragment extends BaseFragment {
    @BindView(R.id.name)
    TextView tvName;
    ...
    public static SIntroduceFragment getInstance(String symbol) {
        SIntroduceFragment introduceFragment = new SIntroduceFragment();
