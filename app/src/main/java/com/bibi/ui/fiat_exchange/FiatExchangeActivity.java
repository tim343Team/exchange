package com.bibi.ui.fiat_exchange;
...
import com.bibi.ui.releaseAd.ReleaseAdsActivity;
...
//    }
    ...
    public void tvBuy(){
        ...
        tvSale.setTextColor(getResources().getColor(R.color.colorPrimary));
        tvBuy.setBackground(getResources().getDrawable(R.drawable.shape_gradient_primary_right));
    ...
    public void tvSale(){
        showSellPage();
        tvBuy.setTextColor(getResources().getColor(R.color.colorPrimary));
        tvSale.setTextColor(getResources().getColor(R.color.white));
        tvBuy.setBackground(null);
        tvSale.setBackground(getResources().getDrawable(R.drawable.shape_gradient_primary_right));
    }
    ...
    @OnClick(R.id.iv_menu_fiat_order)
    public void showFiatMenu(LinearLayout ivMenu) {
        if (MyApplication.getApp().isLogin()) {
            showBottomDialog();
        } else {
            startActivityForResult(new Intent(this, LoginActivity.class), LoginActivity.RETURN_LOGIN);
    ...
    protected int getActivityLayoutId() {
        return R.layout.activity_fiat_exchange_new;
    }
...
//        buyOrSellDialogFragment.show(getActivity().getSupportFragmentManager(), "bottom");
        ...
        LinearLayout ll_cny = popupView.findViewById(R.id.llCny);
        ll_cny.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //TODO
                for (BaseFragment fragment : fragments) {
                    ((C2CFragment) fragment).setPriceType("CNY");
                }
                if (fragments.size() != 0) {
                    ((C2CFragment) fragments.get(vp_fiat_list.getCurrentItem())).loadData();
                }
        ...
        LinearLayout ll_usd = popupView.findViewById(R.id.llUsd);
        ll_usd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //TODO
                for (BaseFragment fragment : fragments) {
                    ((C2CFragment) fragment).setPriceType("USD");
                }
                if (fragments.size() != 0) {
                    ((C2CFragment) fragments.get(vp_fiat_list.getCurrentItem())).loadData();
                }
