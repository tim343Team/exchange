...
import com.bibi.customview.lock.LockPatternIndicator;
    ...
    private void patternComplete(List<LockPatternView.Cell> cells) {
        ...
        if (type == 0) {//设置
            if (SetLockActivity.this.cells == null && cells.size() >= 4) {
                ...
                tvMessage.setText(getResources().getString(R.string.gesturesPassThirdPartTip7));
                lockView.setPattern(LockPatternView.DisplayMode.DEFAULT);
        ...
        if (SetLockActivity.this.cells != null) {
            if (isSame(SetLockActivity.this.cells, cells)) {
                if (type == 0) {
                    ...
                    tvMessage.setText(getResources().getString(R.string.Abolish_success));
                    clearCells();
                }
                finish();
                ...
                if (type == 0) {
                    tvMessage.setText(getResources().getString(R.string.pwd_diff));
                } else if (type == 1) {
