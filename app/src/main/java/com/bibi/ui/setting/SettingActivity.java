...
import com.bibi.ui.feed.FeedbackActivity;
...
import com.bibi.utils.okhttp.FileCallback;
...
public class SettingActivity extends BaseActivity implements SettingContact.View {
    ...
    @OnClick(R.id.llStyle)
    void settingStyle(){
        StyleActivity.actionStart(this);
    }
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        line_gonggao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NoticeActivity.actionStart(SettingActivity.this);
            }
        });
        ...
        llSwitchLanguage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void logout() {
        CommonDialogFragment commonDialogFragment=CommonDialogFragment.getInstance(CommonDialogFragment.TYPE_LOGINOUT,getString(R.string.logout_confirm),"",getString(R.string.confirm),getString(R.string.cancle),true);
...
//            WonderfulLogUtils.logi("VersionInfo", "Exception", e);
    ...
    protected void onResume() {
        super.onResume();
        tvLogOut.setVisibility(MyApplication.getApp().isLogin()?View.VISIBLE:View.GONE);
    }
}
