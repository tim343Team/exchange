package com.bibi.ui.change_phone;
...
public class ChangePhoneActivity extends BaseActivity implements ChangePhoneContract.View {
    ...
    protected void obtainData() {
        ...
        tvPhone.setText(getResources().getString(R.string.handsetTailNumber)+phone.substring(7,11)+getResources().getString(R.string.receiveMessageCode));
    }
