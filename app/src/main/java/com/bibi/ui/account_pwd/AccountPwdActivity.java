...
public class AccountPwdActivity extends BaseActivity implements com.bibi.ui.account_pwd.AccountPwdContract.View {
    ...
    private void accountPwd() {
        ...
        if (!jyPassword.equals(repeatPWd)) WonderfulToastUtils.showToast(getResources().getString(R.string.pwd_diff));
