...
public interface AccountPwdContract {
    ...
    interface EditView extends Contract.BaseView<EditPresenter> {
        ...
        void sendEditAccountPwdCodeSuccess(String obj);

        void sendEditAccountPwdCodeFail(Integer code, String toastMessage);
    }

    interface EditPresenter extends Contract.BasePresenter {

        void editAccountPed(String token, String newPassword, String oldPassword, String msgCode, String googleCode);

        void sendEditAccountPwdCode(String token);
    }
