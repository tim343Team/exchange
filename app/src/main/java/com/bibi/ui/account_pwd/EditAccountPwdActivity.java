package com.bibi.ui.account_pwd;
...
public class EditAccountPwdActivity extends BaseActivity implements AccountPwdContract.EditView {
    ...
    private void editPwd() {
        ...
        if(AUTH_GOOGLE_NO.equals(type)){
            ...
            final CommonDialogFragment commonDialogFragment=CommonDialogFragment.getInstance(CommonDialogFragment.TYPE_GOOGLE_CODE,getString(R.string.text_input_google_code),getString(R.string.text_input_google_code),getString(R.string.confirm),getString(R.string.cancle),true);
