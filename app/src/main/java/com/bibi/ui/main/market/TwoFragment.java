...
public class TwoFragment extends BaseNestingTransFragment implements MainContract.TwoView {
    ...
    protected void addFragments() {
        if (favoriteFragment == null)
            fragments.add(favoriteFragment = FavoriteFragment.getInstance());
        if (usdtMarketFragment == null)
            fragments.add(usdtMarketFragment = USDTMarketFragment.getInstance());
        if (btcMarketFragment == null)
            fragments.add(btcMarketFragment = BTCMarketFragment.getInstance());
        if (ethMarketFragment == null)
            fragments.add(ethMarketFragment = ETHMarketFragment.getInstance());
