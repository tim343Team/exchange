...
public class MainPresenter implements MainContract.Presenter {
    ...
    @Override
    public void newTickerCurrency(final String nav, String content) {
        dataRepository.newTickerCurrency(nav,content,new DataSource.DataCallback() {
            @Override
            public void onDataLoaded(Object obj) {
                view.newTickerSuccess(obj,nav);
            }
