...
import com.bibi.ui.main.presenter.C2CPresenter;
...
public class C2CFragment extends BaseLazyFragment implements MainContract.C2CView {
    ...
    private void refresh() {
        if (coinInfo != null) {
            pageNo = 1;
            presenter.advertise(pageNo, pageSize, advertiseType,priceType, coinInfo.getId());
  ...
  /*  @Override
    ...
    private void initRvAds() {
        ...
        adapter = new C2CAdapter(getActivity(), priceType, R.layout.adapter_c2c_new, c2cs);
