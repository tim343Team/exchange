...
public class C2CPresenter implements MainContract.C2CPresenter {
    ...
    @Override
    public void advertise(int pageNo, int pageSize, String advertiseType,String unit, String id) {
        dataRepository.advertise(pageNo, pageSize, advertiseType,unit, id, new DataSource.DataCallback() {
            @Override
