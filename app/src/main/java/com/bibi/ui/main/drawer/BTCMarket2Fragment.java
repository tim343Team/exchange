...
public class BTCMarket2Fragment extends MarketBaseFragment implements ICommonView {
    ...
    public static BTCMarket2Fragment getInstance( ) {
    ...
    private void initRvContent() {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ((MarketOperateCallback) getActivity()).itemClick(BTCMarket2Fragment.this.adapter.getItem(position),1);
            }
        });
