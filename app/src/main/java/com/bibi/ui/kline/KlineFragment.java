...
//                        Log.d("jiejie", "222222" + response);
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        if(isFace){ // 已经收藏
            //tv_collect
            mTvCollect.setText(getResources().getString(R.string.text_collected));
        }else {
            mTvCollect.setText(getResources().getString(R.string.text_add_favorite));
        }
    }
...
//        fragments.add(KDataFragment.getInstance(KDataFragment.Type.LINE, symbol));
    ...
    protected void fillWidget() {
        ...
        tvSell.setText(getResources().getString(R.string.text_sale) + str[0]);
        tvBuy.setText(getResources().getString(R.string.text_buy) + str[0]);
    }
