...
//         将K线控的滑动事件传递给交易量控件
    ...
    private void updateText(int index) {
        ...
        tvKInfo.setText(openText+" " + MyUtils.getDecimalFormatVol(minutesBean.open) + " "+highText+" " + MyUtils.getDecimalFormatVol(minutesBean.high) + " "+lowText+" " +
                MyUtils.getDecimalFormatVol(minutesBean.low) + " "+closeText+" " + MyUtils.getDecimalFormatVol(minutesBean.close) + " "+rateText+" " + changePercentage);
...
//            barEntries.add(new BarEntry(mData.getDatas().get(i).cjnum, i));
            ...
            BarDataSet barDataSet = new BarDataSet(barEntries, getResources().getString(R.string.text_volume));
