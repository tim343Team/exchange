...
import com.bibi.adapter.OrderAdapter;
...
//        presenter.myOrder(getmActivity().getToken(), status.getStatus(), pageNo, pageSize);
    ...
    public enum StatusSub {
        CANC(0, MyApplication.getApp().getResources().getStringArray(R.array.order_status_sub)[3]),
        UNPAID(1, MyApplication.getApp().getResources().getStringArray(R.array.order_status_sub)[0]),
        PAID(2, MyApplication.getApp().getResources().getStringArray(R.array.order_status_sub)[1]),
        DONE(3, MyApplication.getApp().getResources().getStringArray(R.array.order_status_sub)[2]),
        COMPLAINING(4, MyApplication.getApp().getResources().getStringArray(R.array.order_status_sub)[4]);

        private int status;
        private String statusStr;

        StatusSub(int status, String statusStr) {
            this.status = status;
            this.statusStr = statusStr;
        }
