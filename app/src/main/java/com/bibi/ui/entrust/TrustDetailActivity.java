...
//    TextView mDetailChg; // 手续费
    ...
    protected void obtainData() {
        if ("BUY".equals(historyOrder.getDirection())) {
            mDetailType.setText(getResources().getString(R.string.text_buy));
            mDetailType.setTextColor(ContextCompat.getColor(MyApplication.getApp(), R.color.typeGreen));
        } else {
            mDetailType.setText(getResources().getString(R.string.text_sale));
            mDetailType.setTextColor(ContextCompat.getColor(MyApplication.getApp(), R.color.typeRed));
        }
        mDetailName.setText(symbol);
        mDetailTotal.setText(getResources().getString(R.string.text_total_deal) + "(" + historyOrder.getBaseSymbol() + ")");
        ;
        mDetailFour.setText(getResources().getString(R.string.text_average_price) + "(" + historyOrder.getBaseSymbol() + ")");
        mDetailFive.setText(getResources().getString(R.string.text_volume) + "(" + historyOrder.getCoinSymbol() + ")");
        // 成交总额
